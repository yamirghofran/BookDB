...
class NeuMF(torch.nn.Module):
    ...
    def load_pretrain_weights(self):
        ...
        resume_checkpoint(mlp_model, model_dir=config['pretrain_mlp'], device=self.device)
        ...
        if config['use_cuda'] is True:
            gmf_model.to(self.device)
        resume_checkpoint(gmf_model, model_dir=config['pretrain_mf'], device=self.device)
